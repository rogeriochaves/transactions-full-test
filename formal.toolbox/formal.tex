...
\@x{}\moduleLeftDash\@xx{ {\MODULE} formal}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Integers ,\, Sequences}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLE} accounts ,\, initialBalances ,\, balances ,\, msgs}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} accounts \.{=} \{\@w{Alice} ,\,\@w{Bob} \}}%
 \@x{\@s{16.81} \.{\land}\@s{7.77} initialBalances \.{=} [ acc \.{\in}
 accounts \.{\mapsto} 10 ]}%
\@x{\@s{16.81} \.{\land}\@s{7.77} balances \.{=} initialBalances}%
\@x{\@s{16.81} \.{\land}\@s{7.77} msgs \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{ DbUpdate \.{\defeq} msgs \.{\neq} \{ \}}%
 \@x{\@s{61.96} \.{\land} \.{\LET} msg \.{\defeq} {\CHOOSE} msg \.{\in} msgs
 \.{:} {\TRUE}}%
\@x{\@s{73.07} \.{\IN} msgs \.{'} \.{=} msgs \.{\cap} \{ msg \}}%
 \@x{\@s{73.07} \.{\land}\@s{9.28} balances \.{'} \.{=} [ balances {\EXCEPT}
 {\bang} [ msg . account ] \.{=} msg . amount ]}%
 \@x{\@s{73.07} \.{\land}\@s{9.28} {\UNCHANGED} {\langle} accounts ,\,
 initialBalances {\rangle}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\@s{150.39} \.{\land}\@s{7.77} msgs \.{'} \.{=} msgs \.{\cup} \{ [
 account \.{\mapsto} from ,\, amount \.{\mapsto} balances [ from ] \.{-}
 amount ] ,\,}%
 \@x{\@s{245.08} [ account \.{\mapsto} to ,\, amount \.{\mapsto} balances [ to
 ] \.{+} amount ] \}}%
 \@x{\@s{150.39} \.{\land}\@s{7.77} {\UNCHANGED} {\langle} accounts ,\,
 initialBalances ,\, balances {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} DbUpdate}%
\@x{\@s{20.94} \.{\lor}\@s{7.77} \E\, acc \.{\in} accounts \.{:}}%
 \@x{\@s{47.05} balances [ acc ] \.{>} 0 \.{\land} \E\, amount \.{\in} 1
 \.{\dotdot} balances [ acc ] \.{:}}%
\@y{\@s{0}%
 Send only positive integers, from property testing
}%
\@xx{}%
\@x{\@s{55.25} TransferMoney (\@w{Alice} ,\,\@w{Bob} ,\, amount )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\end{lcom}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} msgs \.{\subseteq} [ account \.{:} accounts ,\, amount
 \.{:} Int}%
\@y{\@s{0}%
 Amount has to be an integer, from static typing
}%
\@xx{ ]}%
\@pvspace{8.0pt}%
 ...
 balances [ acc ] \.{\geq} 0}%
\@pvspace{8.0pt}%
 \@x{ TotalMoneyStable \.{\defeq} \.{\LET} Sum ( S ) \.{\defeq} [ x ,\, y
 \.{\in} S \.{\mapsto} x \.{+} y ]}%
\@x{\@s{97.09} \.{\IN} Sum ( initialBalances ) \.{=} Sum ( balances )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 19:47:28 \ensuremath{CEST} 2021 by \ensuremath{rchaves
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Aug} 07 23:59:18
