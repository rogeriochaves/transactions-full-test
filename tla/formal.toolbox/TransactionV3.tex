...
\@x{}\moduleLeftDash\@xx{ {\MODULE} TransactionV3}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\@s{150.39} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{ [ from
 \.{\mapsto} from}%
\@x{\@s{237.30} ,\, to \.{\mapsto} to}%
\@x{\@s{237.30} ,\, amount\_from \.{\mapsto} balances [ from ] \.{-} amount}%
\@x{\@s{237.30} ,\, amount\_to \.{\mapsto} balances [ to ] \.{+} amount}%
\@x{\@s{237.30} ] \}}%
\@x{\@s{150.39} \.{\land} {\UNCHANGED} {\langle} balances {\rangle}}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 13 13:19:29 \ensuremath{CEST} 2021 by \ensuremath{rchaves
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
