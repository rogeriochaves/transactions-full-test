...
\@x{}\moduleLeftDash\@xx{ {\MODULE} TransactionV1}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{\@s{150.39} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{}%
 \@x{\@s{165.60} [ account \.{\mapsto} from ,\, amount \.{\mapsto} balances [
 from ] \.{-} amount ] ,\,}%
 \@x{\@s{165.60} [ account \.{\mapsto} to ,\, amount \.{\mapsto} balances [ to
 ] \.{+} amount ]}%
\@x{\@s{154.49} \}}%
...
\@pvspace{8.0pt}%
 ...
 \.{:} Int}%
\@y{\@s{0}%
 Amount has to be an number, from static typing
}%
\@xx{ ]}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 13 12:15:31 \ensuremath{CEST} 2021 by \ensuremath{rchaves
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
