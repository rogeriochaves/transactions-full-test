...
\@x{ Next \.{\defeq} DbUpdate}%
 ...
 \.{:}}%
\@x{\@s{50.94} \E\, amount \.{\in} 1 \.{\dotdot} balances [ from ] \.{:}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 ...
 balances [ acc ] \.{\geq} 0}%
\@pvspace{8.0pt}%
 \@x{ TotalMoneyStable \.{\defeq} \.{\LET} Sum ( balance ) \.{\defeq} [ x ,\,
 y \.{\in} accounts \.{\mapsto} balance [ x ] \.{+} balance [ y ] ]}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 20:56:01 \ensuremath{CEST} 2021 by \ensuremath{rchaves
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
